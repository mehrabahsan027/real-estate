...
const Hero = () => {
  return (
    <section className="bg-gradient-to-r from-indigo-600 to-cyan-700 text-white py-20">
      <div className="container mx-auto text-center px-4">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4 animate-intro mt-10">
