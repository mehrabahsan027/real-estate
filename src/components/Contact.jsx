...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 bg-gradient-to-t from-cyan-100 to-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          {/* Contact Form */}
          <div className="w-full lg:w-1/2 bg-gradient-to-tl from-cyan-100 to-purple-50 p-10 rounded-lg shadow-xl">
            <h3 className="text-2xl font-semibold text-stone-900 mb-6 text-center lg:text-left">
              Send Us a Message
            </h3>
